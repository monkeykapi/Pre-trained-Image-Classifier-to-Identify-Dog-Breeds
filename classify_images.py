...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       current_image_path = images_dir+"/"+key 
       ...
       # as classifier label
       model_label = classifier(current_image_path,model) 
       ...
       #           is named model_label.
        # this is model label is result from the clssfier label thus this is the classifer label 
       ...
       if truth in model_label:
            results_dic[key].extend([model_label]) # adding the classifer if there is a match 
