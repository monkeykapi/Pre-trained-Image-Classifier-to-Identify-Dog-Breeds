...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and ((results_stats_dic['n_correct_dog'] + results_stats_dic['n_correct_notdogs'])!= results_stats_dic['n_images'])):
    ...
    if (print_incorrect_breed and (results_stats_dic['n_correct_dog'] != results_stats_dic['n_correct_breed'])):
